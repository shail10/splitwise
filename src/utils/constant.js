export const GET_ALL_TRANSACTION = 'all-transaction';
export const CURRENT_USER = 'current-user';
export const ALL_USERS = 'total-users';
export const ADD_EXPENSES = 'addExpenses';
export const REMOVE_TRANSACTION_STATE = 'removeTransactionState';
export const SET_INITIAL_TRANSACTION_STATE = 'setInitialTransactionState';
